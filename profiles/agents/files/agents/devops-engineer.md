...
description: "Use for deployment topology, CI/CD, Kubernetes/Helm, cloud infra (AWS/GCP/Azure), networking, autoscaling, secrets/IAM, IaC (Terraform/Pulumi/Ansible), container builds, or observability pipelines. Automation-first; bring in during discovery, not post-hoc."
model: opus
color: magenta
---
