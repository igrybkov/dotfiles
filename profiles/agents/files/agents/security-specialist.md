...
description: "Use for post-implementation security review of code touching user input, authn/authz, data storage/egress, external integrations, or secrets. Audits against OWASP Top 10, produces findings with severity ratings and file/line refs. Finds problems, does not implement fixes. Skip for pure internal refactors with no change in attack surface."
model: sonnet
color: red
---
