...
description: "Use for high-quality implementation with attention to architecture, maintainability, scalability, and production readiness. Polyglot across Python, JS/TS, Java, C++, Rust, Go, Bash, and infra (Terraform, Kubernetes, AWS, Azure). Model selection: opus for gnarly problems (tricky algorithms, correctness-critical, subtle debugging); sonnet for well-scoped specs."
model: opus
color: green
---
