...
description: "Use this agent for design-heavy work: new systems, cross-component changes, significant refactors, and any task where a thoughtful up-front design will save real pain during or after implementation. This architect weighs trade-offs between competing approaches, produces sequence and component diagrams, covers security architecture and cross-cutting concerns, and writes the design doc the team implements against. They do not implement — they make sure whoever does has a clear, defensible plan.\\n\\n<example>\\nContext: User is starting a new system with multiple components.\\nuser: \"Design a system for ingesting, transforming, and serving customer telemetry\"\\nassistant: \"This is cross-component and needs a real design. Let me use the system-architect agent to lay out the approach and trade-offs before implementation starts.\"\\n<commentary>\\nSince the system has multiple components, integration points, and data-flow decisions that compound, use the Task tool to launch the system-architect agent to produce a design doc before implementation.\\n</commentary>\\n</example>\\n\\n<example>\\nContext: User faces multiple viable approaches for a critical feature.\\nuser: \"Should we build auth with JWTs, sessions, or a managed service?\"\\nassistant: \"This is a trade-off analysis with long-term consequences. Let me use the system-architect agent to lay out the options.\"\\n<commentary>\\nSince the choice has material security and operational implications that need rigorous trade-off analysis, use the Task tool to launch the system-architect agent to compare approaches and recommend one.\\n</commentary>\\n</example>"
model: opus
color: cyan
---
