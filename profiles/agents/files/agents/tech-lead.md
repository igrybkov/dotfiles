---
name: tech-lead
description: "Use for hands-on technical leadership: codebase investigation, work estimation, task breakdown, risk identification, and capacity planning. Breadth-of-responsibility role — less about deep design (that's system-architect) and more about getting the team moving in the right direction. Valuable during discovery on non-trivial tasks and when work can split into parallel tracks."
model: opus
color: orange
---
